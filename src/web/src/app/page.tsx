...
function WaitlistForm() {
  ...
  if (status === 'success') {
    return (
      <div className="flex items-center justify-center gap-2 py-3 px-6 rounded-full bg-green-500/10 border border-green-500/30 text-green-400">
        <Check className="h-5 w-5" />
        <span className="font-medium">{t('landing.waitlistSuccess')}</span>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full max-w-md mx-auto">
      <div className="relative flex-1">
        ...
        <input
          ...
          required
          className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-dark-800 border border-dark-700 text-dark-100 placeholder:text-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 text-sm"
        />
      </div>
      <Button
        type="submit"
        ...
        className="gap-2 shadow-lg shadow-primary-500/25 whitespace-nowrap"
      >
        {status === 'loading' ? (
    ...
    <div className="min-h-screen bg-gradient-to-b from-dark-950 via-dark-900 to-dark-950">
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        <div className="mx-auto max-w-2xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-sm font-medium mb-4">
            <CalendarClock className="h-4 w-4" />
            {t('landing.draftBadge')}
          </div>
          <h2 className="text-3xl font-bold mb-2">{t('landing.waitlistTitle')}</h2>
          ...
          <div className="mt-6">
            <Link href="/ask">
              <Button variant="ghost" size="sm" className="gap-2 text-dark-400 hover:text-dark-200">
