            ...
            <>
              ...
              <div className="bg-dark-800/50 border border-dark-700 rounded-xl p-6 mb-6">
                <div className="flex items-center gap-6">
                  {dossier.player.headshot_url ? (
                    <img
                      src={dossier.player.headshot_url}
                      alt={dossier.player.name}
                      className="w-20 h-20 rounded-xl object-cover bg-dark-700"
                    />
                  ) : (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-2 text-dark-400">
                      ...
                      <span>{getSportDisplayName(dossier.player.sport)}</span>
                    </div>
                  </div>
                  <div className="hidden sm:flex items-center gap-4">
                    {dossier.summary.latest_median !== undefined && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-dark-800/50 border border-dark-700 rounded-xl p-6">
                    ...
                    {dossier.indices.length > 0 ? (
                      ...
                      <p className="text-dark-500 text-sm">No index data available yet. Indices are calculated when decisions are made.</p>
                    )}
                  </div>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-dark-700 text-dark-400">
                            ...
                            {/* Dynamic stat columns from first game log */}
              ...
              {activeTab === 'decisions' && (
                <div className="bg-dark-800/50 border border-dark-700 rounded-xl p-6">
                  ...
                  {dossier.decisions.length > 0 ? (
                    ...
                    <p className="text-dark-500 text-sm">No decisions have been made involving this player yet.</p>
                  )}
                </div>
              )}
            </>
