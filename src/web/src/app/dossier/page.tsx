        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-dark-400 mt-2">
              ...
              Search for any player to view their full dossier.
            </p>
          </div>
          ...
          {searching ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-dark-500 mt-2">
                Enter a player name above to view their comprehensive dossier with
                stats, indices, game logs, and decision history.
              </p>
            </div>
          )}
        </div>
