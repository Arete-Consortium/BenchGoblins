...
@pytest.fixture
def soccer_forward_stats():
    """Sample soccer forward stats (FPL-style)."""
    from core.scoring import PlayerStats
    ...
    return PlayerStats(
        ...
        chances_created=2.1,
        progressive_passes=3.5,
        carries_final_third=4.8,
        tackles_won=0.5,
        aerial_duels_won=4.2,
        clean_sheets=0.0,
        minutes_played=85.0,
        fixture_difficulty=2.0,
        set_piece_involvement=1.0,
...
def soccer_midfielder_stats():
    ...
    return PlayerStats(
        ...
        assists_soccer=10.0,
        expected_goals=11.0,
        expected_assists=9.5,
        chances_created=3.8,
        progressive_passes=8.2,
        carries_final_third=3.0,
        tackles_won=2.5,
        aerial_duels_won=1.8,
        clean_sheets=8.0,
        minutes_played=88.0,
        fixture_difficulty=4.0,
        set_piece_involvement=5.0,
        expected_minutes=90.0,
        is_starter=True,
        games_started_pct=0.92,
        games_played=32,
...
def soccer_goalkeeper_stats():
    ...
    return PlayerStats(
        ...
        chances_created=0.0,
        progressive_passes=2.5,
        carries_final_third=0.0,
        tackles_won=0.0,
