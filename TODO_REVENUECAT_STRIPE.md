...
### 4. Verify
- [ ] Test: `curl -s -H "Authorization: Bearer rcb_YOUR_REVENUECAT_API_KEY" "https://api.revenuecat.com/v1/subscribers/test_user/offerings"` — packages should no longer be empty
